...
const INDICATORS: Def[] = [
  {
    ...
    coverImageUrl: "/api/indikator-cover/rsi",
  ...
  {
    slug: "piphunter-bollinger-bands-mt5",
    title: "Konsep Bollinger Bands (stub) MT5",
    clientFileName: "PipHunter_Bollinger_Sample.mq5",
    coverImageUrl: "/api/indikator-cover/bollinger-bands",
    description: `<p>Pengenalan <strong>Bollinger Bands</strong>: pita volatilitas di sekitar harga. Lampiran stub untuk memahami ide middle band dan deviasi sebelum menulis logika sendiri.</p><p>Penulis: <strong>PipHunter</strong> · Gratis · MT5.</p>`,
  },
  {
    slug: "piphunter-stochastic-mt5",
    title: "Stochastic — osilator (stub) MT5",
    clientFileName: "PipHunter_Stochastic_Sample.mq5",
    coverImageUrl: "/api/indikator-cover/stochastic",
    description: `<p>Garis besar <strong>Stochastic</strong> (%K / %D) sebagai osilator momentum. File .mq5 adalah titik awal edukasi, bukan sinyal otomatis.</p><p>Penulis: <strong>PipHunter</strong> · Gratis · MT5.</p>`,
  },
  {
    slug: "piphunter-atr-volatilitas-mt5",
    title: "ATR & volatilitas (stub) MT5",
    clientFileName: "PipHunter_ATR_Sample.mq5",
    coverImageUrl: "/api/indikator-cover/atr",
    description: `<p><strong>ATR (Average True Range)</strong> mengukur rentang harga rata-rata — berguna untuk konteks risiko dan jarak stop. Stub untuk latihan membaca dan menampilkan nilai.</p><p>Penulis: <strong>PipHunter</strong> · Gratis · MT5.</p>`,
  },
  {
    slug: "piphunter-fibonacci-retracement-mt5",
    title: "Level Fibonacci retracement (stub) MT5",
    clientFileName: "PipHunter_Fibonacci_Sample.mq5",
    coverImageUrl: "/api/indikator-cover/fibonacci",
    description: `<p>Konsep <strong>retracement Fibonacci</strong> sebagai referensi level, bukan jaminan harga. Stub untuk bereksperimen dengan swing high/low di kode Anda.</p><p>Penulis: <strong>PipHunter</strong> · Gratis · MT5.</p>`,
  },
  {
    slug: "piphunter-pivot-points-mt5",
    title: "Pivot point R1/P/S1 (stub) MT5",
    clientFileName: "PipHunter_Pivot_Sample.mq5",
    coverImageUrl: "/api/indikator-cover/pivot-points",
    description: `<p>Ide <strong>pivot point</strong> dan level support/resistance harian yang turunannya. Lampiran stub — rumus dan sesi harus disesuaikan dengan kebutuhan Anda.</p><p>Penulis: <strong>PipHunter</strong> · Gratis · MT5.</p>`,
  },
  {
    slug: "piphunter-ichimoku-mt5",
    title: "Ichimoku — awan & garis (stub) MT5",
    clientFileName: "PipHunter_Ichimoku_Sample.mq5",
    coverImageUrl: "/api/indikator-cover/ichimoku",
    description: `<p>Gambaran komponen <strong>Ichimoku</strong> (awan, Tenkan, Kijun, dll.) untuk pembelajaran. Skrip stub; parameter standar bisa Anda ubah di MetaEditor.</p><p>Penulis: <strong>PipHunter</strong> · Gratis · MT5.</p>`,
  },
  {
    slug: "piphunter-cci-osilator-mt5",
    title: "CCI — Commodity Channel Index (stub) MT5",
    clientFileName: "PipHunter_CCI_Sample.mq5",
    coverImageUrl: "/api/indikator-cover/cci",
    description: `<p>Pengantar <strong>CCI</strong> sebagai osilator di sekitar nol dan zona overbought/oversold relatif. File edukasi stub, bukan rekomendasi trading.</p><p>Penulis: <strong>PipHunter</strong> · Gratis · MT5.</p>`,
  },
];
