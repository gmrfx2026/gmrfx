...
const DEFAULTS: Record<SiteHeaderNavKey, { label: string; sortOrder: number }> = {
  ...
  berita: { label: "Berita", sortOrder: 4 },
  cari: { label: "Cari", sortOrder: 5 },
  galeri: { label: "Galeri", sortOrder: 6 },
  daftar: { label: "Daftar", sortOrder: 7 },
  login: { label: "Login", sortOrder: 8 },
  dashboard: { label: "Dashboard", sortOrder: 9 },
  admin: { label: "Admin", sortOrder: 10 },
};
